...
#relacion numero de clase con visualizacion
...
mean(views)
sd(views)
#Regresion lineal: recta que
#esta mas cerca de todos los puntos
#se puede ver varianza, ajustar y predicciones
#Regresion lineal
...
pairs(datos)
cor(datos)
#estimar views con numero de clases
